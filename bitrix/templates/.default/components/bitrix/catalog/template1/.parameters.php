...
if (ModuleManager::isModuleInstalled("blog")) {
	$arTemplateParameters["IS_MAIL"] = array(
		"NAME" => "Send Mail",
		"PARENT" => "EXTENDED_SETTINGS",
        "NAME" => "Отправлять комментарии на почту админу",
        "TYPE" => "CHECKBOX",
        "REFRESH" => "N",
		"DEFAULT" => "Y",
	  );
	$arTemplateParameters["MAIL_ADRESS"] = array(
        "PARENT" => "EXTENDED_SETTINGS",
        "NAME" => "Дополнительные адреса отправки комментариев",
        "TYPE" => "STRING",
        "MULTIPLE" => "Y",
        "ADDITIONAL_VALUES" => "Y",
        "REFRESH" => "N",
