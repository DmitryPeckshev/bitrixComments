...
{
	$arComponentParameters["GROUPS"]["COMM"] = array("NAME" => "Comment to Mail");
	$arComponentParameters["PARAMETERS"]["IS_MAIL"] = array(
		"NAME" => "Send Mail",
		"PARENT" => "COMM",
        "NAME" => "Enable mail",
        "TYPE" => "CHECKBOX",
	...
	$arComponentParameters["PARAMETERS"]["MAIL_ADRESS"] = array(
        "PARENT" => "COMM",
        "NAME" => "Mail adress",
        "TYPE" => "STRING",
        "MULTIPLE" => "Y",
